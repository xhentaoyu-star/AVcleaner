...
- Verify `release\AVcleaner-v0.8.2-portable-win-x64.zip.sha256`.
- Verify SHA256 with
  `Get-FileHash .\release\AVcleaner-v0.8.2-portable-win-x64.zip -Algorithm SHA256`.
- Verify `release\artifact-manifest.json`.
- Test on a clean Windows 10/11 x64 VM before public release.
- v0.8.2 clean Windows manual checklist:
