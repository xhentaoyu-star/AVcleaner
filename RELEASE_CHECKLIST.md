...
- Verify the zip with
  `.\scripts\check_artifact.ps1 .\release\AVcleaner-v0.7.5-portable-win-x64.zip`.
- Smoke-test the final zip directly with
  `.\scripts\smoke_release_zip.ps1 .\release\AVcleaner-v0.7.5-portable-win-x64.zip`.
- Verify `release\AVcleaner-v0.7.5-portable-win-x64.zip.sha256`.
- Verify SHA256 with
  `Get-FileHash .\release\AVcleaner-v0.7.5-portable-win-x64.zip -Algorithm SHA256`.
- Verify `release\artifact-manifest.json`.
- Test on a clean Windows 10/11 x64 VM before public release.
- v0.7.5 clean Windows manual checklist:
