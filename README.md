...
1. 到 GitHub Releases 下载最新便携版 `AVcleaner-v0.8.0-portable-win-x64.zip`。
...
1. Download the latest portable build from GitHub Releases: `AVcleaner-v0.8.0-portable-win-x64.zip`.
